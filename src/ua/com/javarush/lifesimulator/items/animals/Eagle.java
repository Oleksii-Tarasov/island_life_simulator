...
public class Eagle extends Animal implements Carnivores {
    ...
    public Eagle(String animalType, double weight, int maxAmountOnCell, int speed, double fullSaturation, double weightLossPerDay, String icon) {
    ...
    @Override
    public Animal clone() {
        return new Eagle(animalType, weight, maxAmountOnCell, speed, fullSaturation, weightLossPerDay, icon);
    }
}
