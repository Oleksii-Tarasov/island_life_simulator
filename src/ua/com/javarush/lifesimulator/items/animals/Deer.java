...
public class Deer extends Animal implements Herbivores {
    ...
    public Deer(String animalType, double weight, int maxAmountOnCell, int speed, double fullSaturation, double weightLossPerDay, String icon) {
    ...
    @Override
    public Animal clone() {
        return new Deer(animalType, weight, maxAmountOnCell, speed, fullSaturation, weightLossPerDay, icon);
    }
}
