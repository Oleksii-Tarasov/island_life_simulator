...
public class Rabbit extends Animal implements Herbivores {
    ...
    public Rabbit(String animalType, double weight, int maxAmountOnCell, int speed, double fullSaturation, double weightLossPerDay, String icon) {
    ...
    @Override
    public Animal clone() {
        return new Rabbit(animalType, weight, maxAmountOnCell, speed, fullSaturation, weightLossPerDay, icon);
    }
}
