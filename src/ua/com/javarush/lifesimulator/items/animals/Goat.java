...
public class Goat extends Animal implements Herbivores {
    ...
    public Goat(String animalType, double weight, int maxAmountOnCell, int speed, double fullSaturation, double weightLossPerDay, String icon) {
    ...
    @Override
    public Animal clone() {
        return new Goat(animalType, weight, maxAmountOnCell, speed, fullSaturation, weightLossPerDay, icon);
    }
}
